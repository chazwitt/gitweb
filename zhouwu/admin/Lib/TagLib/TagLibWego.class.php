     ...
     //   $content    =   $tag['content'];
        ...
        switch(strtoupper($type)) {
            ...
            case 'UBB':
                ...
                break;
            case 'KINDEDITOR':                
                $parseStr='<script type="text/javascript" src="__ROOT__/statics/kindeditor585858/kindeditor.js"></script><script type="text/javascript" src="__ROOT__/statics/kindeditor585858/lang/zh_CN.js"></script><script> var editor; KindEditor.ready(function(K) { editor = K.create(\'#'.$id.'\');});</script><textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" >'.$content.'</textarea>';
                break;
            default :
