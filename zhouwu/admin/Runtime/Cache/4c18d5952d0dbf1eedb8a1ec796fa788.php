...
<html xmlns="http://www.w3.org/1999/xhtml" class="off">
    ...
    <body scroll="no">
        <div id="header">
            ...
            <div class="col-auto" style="overflow: visible">
                <div class="log white cut_line">
                    欢迎您！<?php echo ($my_info["user_name"]); ?> [<?php echo ($admin_level["name"]); ?>] |
            ...
            <div class="right_main">
                <div class="crumbs">
                    <div class="shortcut cu-span">
                        ...
                        <a href="<?php echo u('index/cache');?>" target="right">
                            <span>
                                更新后台缓存
                            </span>
                        </a>
        ...
        <script type="text/javascript">
            ...
            $(function(){
				//默认载入左侧菜单
				$("#leftMain").load("<?php echo u('public/menu', array('tag'=>'1'));?>");
				$.get("<?php echo u('index/current_pos', array('tag'=>'1'));?>", function(data){
