...
//查询商户ID和商户Key的网址：http://www.1zhifu.net/SiteModify.asp

//此处请修改为自己的商户ID (将100修改为您自己的数字ID)
$WebID	=	5604;

//此处请修改为自己的商户Key (Key = "ABCD" ,修改""号内 ABCD 为您的密钥)
$Key	=	"ad6b0c11e442a0fda1786b58597f139e";

//此处请修改为商户在易支付网站绑定的支付宝账号
//绑定支付宝账号的网址：http://www.1zhifu.net/Download.asp
//若绑定多个支付宝账号，请用“;”英文分号分隔，并运行多个软件
$AliAccount	=	"qianme1731@163.com";
