...
<title><?php echo ($catename); ?>--<?php echo ($set["webname"]); ?></title>
...
<dd><a href="<?php echo u('user/out');?>">退出登录</a></dd>
	...
	<div class="uright fr">
		<div class="userbox">
			<div class="tit">
				<span class="t"><a href="<?php echo u('user/index');?>">会员首页</a>  > <?php echo ($catename); ?></span>
			</div>
			<div class="con userinfo">
				<div class="myarticle clear mt10">
					<dl>
                     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><dd><span class="pubdate"><?php echo ($val["add_time"]); ?></span><a href="<?php echo u('user/show', array('id'=>$val['id']));?>"><?php echo ($val["title"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>  
