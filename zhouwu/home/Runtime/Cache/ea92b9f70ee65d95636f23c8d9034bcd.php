...
<title>用户登录--<?php echo ($set["webname"]); ?></title>
...
<div class="loginbg">
	<div class="W">
		<div id="login">
			<div class="title">会员登录 LOGIN</div>
			<div class="con">
				<form name="myform" action="<?php echo u('index/checklogin');?>" method="post">
				<table border="0" cellpadding="3" cellspacing="0" width="226">
					...
					<tr>
						<td>
							<a href="#" onClick="return checkmyform()"><img src="__ROOT__/statics/home/images/loginbgt.jpg"/></a>
						</td>
					</tr>
					<tr>
						<td>
							<a href="<?php echo u('index/reg');?>"><u>注册新账号</u></a>&nbsp;&nbsp;
							<a href="<?php echo u('index/getpass');?>"><u>找回密码</u></a>
						</td>
					</tr>
				</table>
				</form>
