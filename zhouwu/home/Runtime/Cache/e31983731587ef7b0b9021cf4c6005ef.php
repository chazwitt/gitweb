...
<html>
    <head>
        ...
        <title><?php echo ($title); ?>--<?php echo ($set["webname"]); ?></title>
            ...
            <div class="userbox">
                ...
                <div class="con userinfo">
                    <div class="myarticle clear mt10">
                          ...
                          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><dl>
                            <dt><?php echo ($val["name"]); ?><span class="more fr"><a href="<?php echo u('user/clist', array('cid'=>$val['id']));?>">更多...</a></span></dt>
                            
                             <?php if(is_array($val['news'])): $i = 0; $__LIST__ = $val['news'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><dd><span class="pubdate"><?php echo ($val["add_time"]); ?></span><a href="<?php echo u('user/show', array('id'=>$val['id']));?>"><?php echo ($val["title"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
