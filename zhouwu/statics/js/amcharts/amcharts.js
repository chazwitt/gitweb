...
AmCharts.AmChart = AmCharts.Class({
    ...
    initChart: function() {
        ...
        if (b && window.getComputedStyle && (b = window.getComputedStyle(b))) this.dmouseY = AmCharts.removePx(b.getPropertyValue("margin-top")),
...
AmCharts.Cuboid = AmCharts.Class({
    ...
    draw: function() {
        ...
        0 < m && (A = AmCharts.line(b, [0, f, d + f], [e, e + g, e + g], l, m, k));
        1 > Math.abs(e) && (e = 0);
        1 > Math.abs(d) && (d = 0);
        ...
        e = 0 > e ? [r, C, u, t, v, x, y, w, A, b] : [w, A, u, t, v, x, r, C, y, b];
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function() {
        ...
        for (v = 0; v < u.length; v++) {
            ...
            C + t.width > n && 0 < v && (x++, y = 0, C = g, w = C + t.width + g + m);
            A.translate(C, (p + l) * x);
            y++; ! isNaN(k) && y >= k && (y = 0, x++);
            q.push(A)
        }
    ...
    draw: function() {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity != this.max) {
                ...
                r; ! 0 === j ? (r = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / r, 2 < r && (q = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, p = Math.round(Math.log(this.minReal) * Math.LOG10E), q > this.gridCount && (s = Math.ceil(q / this.gridCount)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
                d = 0;
                ...
                if (0 < x) {
                    ...
                    for (e = this.fillAlpha = 0; e < x; e++) {
                        ...
                        A = NaN,
                        C = w.above;
                        isNaN(w.toValue) || (A = this.getCoordinate(w.toValue), t = new this.axisItemRenderer(this, A, "", !0, NaN, NaN, w), this.pushAxisItem(t, C));
                        var I = NaN;
                        isNaN(w.value) || (I = this.getCoordinate(w.value), t = new this.axisItemRenderer(this, I, w.label, !0, NaN, (A - I) / 2, w), this.pushAxisItem(t, C));
                        isNaN(A - I) || (t = new this.guideFillRenderer(this, I, A, w), this.pushAxisItem(t, C), t = t.graphics(), w.graphics = t, w.balloonText && this.addEventListeners(t, w))
                    }
                    this.fillAlpha = y
                }
                v = !1;
                for (e = p; e < q; e += s) t = AmCharts.roundTo(this.step * e + this.min, d),
                -1 != String(t).indexOf("e") && (v = !0, String(t).split("e"));
                this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
                for (e = p; e < q; e += s) if (p = this.step * e + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !(this.integersOnly && Math.round(p) != p)) { ! 0 === j && (0 === p && (p = this.minReal), 2 < r && (p = Math.pow(10, e)), v = -1 != String(p).indexOf("e") ? !0 : !1);
    ...
    stackGraphs: function(a) {
        ...
        for (n = this.start; n <= this.end; n++) {
            ...
            for (m = 0; m < j.length; m++) if (l = j[m], !l.hidden && (k = l.type, l.chart == this.chart && (l.valueAxis == this && a == k && l.stackable) && (k = this.data[n].axes[this.id].graphs[l.id], h = k.values.value, !isNaN(h)))) {
                ...
                "regular" == b && (linetype && (isNaN(d[n]) ? (d[n] = h, k.values.close = h, k.values.open = this.baseValue) : (k.values.close = isNaN(h) ? d[n] : h + d[n], k.values.open = d[n], d[n] = k.values.close)), "column" == a && !isNaN(h) && (k.values.close = h, 0 > h ? (k.values.close = h, isNaN(e[n]) ? k.values.open = s: (k.values.close += e[n], k.values.open = e[n]), e[n] = k.values.close) : (k.values.close = h, isNaN(f[n]) ? k.values.open = s: (k.values.close += f[n], k.values.open = f[n]), f[n] = k.values.close)))
            }
        }
        for (n = this.start; n <= this.end; n++) for (m = 0; m < j.length; m++) l = j[m],
        l.hidden || (k = l.type, l.chart == this.chart && (l.valueAxis == this && a == k && l.stackable) && (k = this.data[n].axes[this.id].graphs[l.id], h = k.values.value, isNaN(h) || (d = 100 * (h / g[n]), k.values.percents = d, k.values.total = g[n], "100%" == b && (isNaN(e[n]) && (e[n] = 0), isNaN(f[n]) && (f[n] = 0), 0 > d ? (k.values.close = AmCharts.fitToBounds(d + e[n], -100, 100), k.values.open = e[n], e[n] = k.values.close) : (k.values.close = AmCharts.fitToBounds(d + f[n], -100, 100), k.values.open = f[n], f[n] = k.values.close)))))
    },
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, d, e, f, g, h, j, k) {
        ...
        if ("H" == ea) {
            if (0 <= b && b <= ba + 1 && (0 < t && (0 < u && b + k <= ba + 1) && (ma = AmCharts.line(s, [b + k, b + k], [0, t], r, u, x), p.push(ma)), 0 < v && (W = AmCharts.line(s, [b, b + U, b + U], [fa, fa + S, S], y, v, x, w), p.push(W))), E = 0, F = b, h && 90 == G && (F -= m), !1 === e ? (W = "start", E = "bottom" == N ? Q ? E + t: E - t: Q ? E - t: E + t, F += 3, f && (F += f / 2, W = "middle"), 0 < G && (W = "middle")) : W = "middle", 1 == T && (0 < C && !h && V < ba) && (e = AmCharts.fitToBounds(b, 0, ba), V = AmCharts.fitToBounds(V, 0, ba), $ = e - V, 0 < $ && (fill = AmCharts.rect(s, $, a.height, A, C), fill.translate(e - $ + U, S), p.push(fill))), "bottom" == N ? (E += fa + m / 2 + ca, Q ? 0 < G ? (E = fa - ga / 2 * Math.sin(O) - t - 3, F += ga / 2 * Math.cos(O)) : E -= t + m + 3 + 3 : 0 < G ? (E = fa + ga / 2 * Math.sin(O) + t + 3, F -= ga / 2 * Math.cos(O)) : E += t + q + 3 + 3) : (E += S + m / 2 - ca, F += U, Q ? 0 < G ? (E = ga / 2 * Math.sin(O) + t + 3, F -= ga / 2 * Math.cos(O)) : E += t + 3 : 0 < G ? (E = -(ga / 2) * Math.sin(O) - t - 6, F += ga / 2 * Math.cos(O)) : E -= t + m + 3 + q + 3), "bottom" == N ? $ = (Q ? fa - t - 1 : fa + q - 1) + ca: (z = U, $ = (Q ? S: S - t - q + 1) - ca), g && (F += g), S = F, 0 < G && (S += ga / 2 * Math.cos(O)), X && (N = 0, Q && (N = ga / 2 * Math.cos(O)), S + N > ba + 1 || 0 > S)) X.remove(),
            X = null
        } else {
            0 <= b && b <= fa + 1 && (0 < t && (0 < u && b + k <= fa + 1) && (ma = AmCharts.line(s, [0, t], [b + k, b + k], r, u, x), p.push(ma)), 0 < v && (W = AmCharts.line(s, [0, U, ba + U], [b, b + S, b + S], y, v, x, w), p.push(W)));
            W = "end";
            if (!0 === Q && "left" == N || !1 === Q && "right" == N) W = "start";
            E = b - m / 2;
            1 == T && (0 < C && !h) && (e = AmCharts.fitToBounds(b, 0, fa), V = AmCharts.fitToBounds(V, 0, fa), O = e - V, fill = AmCharts.polygon(s, [0, a.width, a.width, 0], [0, 0, O, O], A, C), fill.translate(U, e - O + S), p.push(fill));
            E += m / 2;
            "right" == N ? (F += U + ba + ca, E += S, Q ? (F -= t + 4, g || (E -= m / 2 + 3)) : (F += t + 4 + q, E -= 2)) : Q ? (F += t + 4 - ca, g || (E -= m / 2 + 3), h && (F += U, E += S)) : (F += -t - q - 4 - 2 - ca, E -= 2);
            ma && ("right" == N ? (z += U + ca + ba, $ += S, z = Q ? z - q: z + q) : (z -= ca, Q || (z -= t + q)));
            g && (E += g);
            Q = -3;
            "right" == N && (Q += S);
            if (X && (E > fa + 1 || E < Q)) X.remove(),
            X = null
        }
        ma && ma.translate(z, $); ! 1 === a.visible && (ma && ma.remove(), X && (X.remove(), X = null));
        X && (X.attr({
            "text-anchor": W
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function() {
        ...
        if (!T && ("line" == g || "smoothedLine" == g || "step" == g)) if (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round", this.resetBullet = !0), Ea || void 0 != ya) {
            var za = S;
            za > f.max && (za = f.max);
            za < f.min && (za = f.min);
            ...
            m ? (X = k, Xa = Math.abs(nb - ta), Za = k, $a = Math.abs(Qa - ta), Pa = Ya = 0, f.reversed ? (Na = 0, Oa = ta) : (Na = ta, Oa = 0)) : (Xa = j, X = Math.abs(nb - ta), $a = j, Za = Math.abs(Qa - ta), Oa = Na = 0, f.reversed ? (Pa = l, Ya = ta) : Pa = ta + 1)
        }
        var ua = Math.round;
        this.pmx = ua(Na);
        this.pmy = ua(Ya);
        ...
        for (L = I; L <= G; L++) {
            ...
            if (sa) {
                ...
                if ("candlestick" == g || "ohlc" == g) R = sa.close,
                Ua = sa.low,
                Aa = f.getCoordinate(Ua),
                Ta = sa.high,
                Ba = f.getCoordinate(Ta);
                ja = sa.open;
                B = f.getCoordinate(R);
                ...
                T || (z.x = pa); - 1E5 > pa && (pa = -1E5);
                pa > j + 1E5 && (pa = j + 1E5);
                m ? (D = B, P = M, M = B = pa, isNaN(ja) && !this.fillToGraph && (P = U), Ra = Aa, Sa = Ba) : (P = D = pa, isNaN(ja) && !this.fillToGraph && (M = U));
                switch (g) {
                case "line":
                    isNaN(R) ? p || (this.drawLineGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (z.isNegative = R < S ? !0 : !1, q.push(D), r.push(B), Y = D, aa = B, qa = D, ra = B, Ha && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M)));
                    break;
                case "smoothedLine":
                    isNaN(R) ? p || (this.drawSmoothedGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (z.isNegative = R < S ? !0 : !1, q.push(D), r.push(B), Y = D, aa = B, qa = D, ra = B, Ha && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M)));
                    break;
                case "step":
                    isNaN(R) ? p || (t = NaN, this.drawLineGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (z.isNegative = R < S ? !0 : !1, m ? (isNaN(u) || (q.push(u), r.push(B - wa)), r.push(B - wa), q.push(D), r.push(B + Ja), q.push(D), Ha && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M - wa), ha.push(P), ia.push(M + Ja))) : (isNaN(t) || (r.push(t), q.push(D - wa)), q.push(D - wa), r.push(B), q.push(D + Ja), r.push(B), Ha && (!isNaN(M) && !isNaN(P)) && (ha.push(P - wa), ia.push(M), ha.push(P + Ja), ia.push(M))), u = D, t = B, Y = D, aa = B, qa = D, ra = B);
                    break;
                case "column":
                    la = na;
                    ...
                    if (!isNaN(R)) {
                        ...
                        if (! (R < ob && (ja < ob || void 0 == ja) || R > pb && ja > pb)) if (m) {
                            "3d" == A ? (K = B - 0.5 * (h + O) + O / 2 + w * ea, J = P + y * ea) : (K = B - (n / 2 - ea) * (h + O) + O / 2, J = P);
                            H = h;
                            Y = D;
                            aa = K + h / 2;
                            qa = D;
                            ...
                            if (K < k && 0 < H && (ka = new AmCharts.Cuboid(e, Z, H, y, w, va, Ia, N, la, V, W, s, m), "bottom" != C)) if (C = f.reversed ? "left": "right", 0 > R) C = f.reversed ? "right": "left";
                            else if ("regular" == A || "100%" == A) Y += this.dx
                        } else {
                            ...
                            if (J < j + ea * y && 0 < H) if (ka = new AmCharts.Cuboid(e, H, Z, y, w, va, Ia, N, la, this.lineAlpha, W, s, m), 0 > R && "middle" != C) C = "bottom";
                            else if (C = ma, "regular" == A || "100%" == A) aa += this.dy
                        }
                        if (ka) {
                            oa = ka.set;
                            oa.translate(J, K);
                            ...
                            if (!T) {
                                ...
                                "3d" == A && (m ? (x = (v - b) * (this.end + 1 - L), Y += y * this.columnIndex, qa += y * this.columnIndex, z.y += y * this.columnIndex) : (x = (v - b) * (L + 1), Y += 3, aa += w * this.columnIndex + 7, ra += w * this.columnIndex, z.y += w * this.columnIndex));
                                if ("regular" == A || "100%" == A) C = "middle",
                    ...
                    if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(R)) {
                        ...
                        if (m) {
                            if (K = B - h / 2, J = P, H = h, K + H > k && (H = k - K), 0 > K && (H += K, K = 0), K < k && 0 < H) {
                                ...
                                B < k && 0 < B && (Va = AmCharts.line(e, bb, [B, B], la, V, N), ab = AmCharts.line(e, cb, [B, B], la, V, N));
                                Z = D - P;
                                ka = new AmCharts.Cuboid(e, Z, H, y, w, va, Fa, N, la, V, W, s, m)
                            }
                        } else if (J = D - h / 2, K = M + N / 2, H = h, J + H > j && (H = j - J), 0 > J && (H += J, J = 0), Z = B - M, J < j && 0 < H) {
                            var ka = new AmCharts.Cuboid(e, H, Z, y, w, va, Ia, N, la, V, W, s, m),
                            db,
                            eb;
                            R > ja ? (db = [B, Ba], eb = [M, Aa]) : (db = [M, Ba], eb = [B, Aa]);
                            D < j && 0 < D && (Va = AmCharts.line(e, [D, D], db, la, V, N), ab = AmCharts.line(e, [D, D], eb, la, V, N))
                        }
                        ka && (oa = ka.set, ca.push(oa), oa.translate(J, K), z.url && oa.setAttr("cursor", "pointer"), Va && (ca.push(Va), ca.push(ab)), Y = D, aa = B, qa = D, ra = B, T || (z.x = m ? K + H / 2 : J + H / 2, this.animateColumns(ka, L, D, P, B, M), this.addListeners(oa, z)))
                    }
                    break;
                case "ohlc":
                    if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(R)) {
                        ...
                        if (m) {
                            ...
                            gb = AmCharts.line(e, [P, P], [ib, qb], na, V, N, ba);
                            0 < B && B < k && (fb = AmCharts.line(e, [Ra, Sa], [B, B], na, V, N, ba));
                            hb = AmCharts.line(e, [D, D], [qb, jb], na, V, N, ba)
                        } else {
                            var kb = D - h / 2,
                            ...
                            gb = AmCharts.line(e, [kb, rb], [M, M], na, V, N, ba);
                            0 < D && D < j && (fb = AmCharts.line(e, [D, D], [Aa, Ba], na, V, N, ba));
                            hb = AmCharts.line(e, [rb, lb], [B, B], na, V, N, ba)
                        }
                        ca.push(gb);
                        ca.push(fb);
                        ca.push(hb);
                    ...
                    if (this.end - this.start <= sb || 0 === sb) {
                        ...
                        if (tb) {
                            ...
                            case "right":
                                ...
                                break;
                            case "bottom":
                                m && "column" == g ? (Y = U, 0 > R ? (xa = -6, da.attr({
                                    "text-anchor": "end"
                                })) : (xa = 6, da.attr({
                                    "text-anchor": "start"
                                ...
                                break;
                            case "middle":
                                "column" == g && (m ? (xa = -(D - P) / 2 - y, 0 > Z && (xa += y), Math.abs(D - P) < Wa && !this.showAllValueLabels && (da.remove(), da = null)) : (Da = -(B - M) / 2, 0 > Z && (Da -= w), Math.abs(B - M) < mb && !this.showAllValueLabels && (da.remove(), da = null)))
                            }
                            if (da) if (!isNaN(aa) && !isNaN(Y)) if (Y += xa, aa += Da, da.translate(Y, aa), m) {
                                if (0 > aa || aa > k) da.remove(),
                                da = null
                            } else {
                                var vb = 0;
                                "3d" == A && (vb = y * ea);
                                if (0 > Y || Y > j + vb) da.remove(),
                                da = null
                            } else da.remove(),
                            da = null
                        }
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(q, r, ha, ia) : this.drawLineGraph(q, r, ha, ia),
    ...
    drawLineGraph: function(a, b, d, e) {
        if (1 < a.length) {
            ...
            if (0 < f && (k = a.join(";").split(";"), l = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), k = a.concat(d), l = b.concat(e)) : this.rotate ? (l.push(l[l.length - 1]), k.push(r), l.push(l[0]), k.push(r), l.push(l[0]), k.push(k[0])) : (k.push(k[k.length - 1]), l.push(r), k.push(k[0]), l.push(r), k.push(a[0]), l.push(l[0]))), a = AmCharts.polygon(g, k, l, n, f, 0, 0, 0, this.gradientRotation), h.push(a), p || void 0 !== s)) q || (q = f),
            p || (p = s),
    ...
    drawSmoothedGraph: function(a, b, d, e) {
        if (1 < a.length) {
            ...
            if (0 < m && (l = a.join(";").split(";"), u = b.join(";").split(";"), k = "", 0 < d.length ? (d.reverse(), e.reverse(), l = a.concat(d), u = b.concat(e)) : (this.rotate ? (k += " L" + r + "," + b[b.length - 1], k += " L" + r + "," + b[0]) : (k += " L" + a[a.length - 1] + "," + r, k += " L" + a[0] + "," + r), k += " L" + a[0] + "," + b[0]), d = new AmCharts.Bezier(g, l, u, NaN, 0, 0, n, m, f, k), h.push(d.path), p || void 0 !== s)) q || (q = m),
            p || (p = s),
    ...
    createBullet: function(a, b, d) {
        ...
        if (j) {
            ...
            if ("serial" == this.chartType && (0 > b - f || b - f > this.width || d < -g / 2 || d - h > this.height)) j.remove(),
            j = null;
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    createCursor: function() {
        ...
        this.set.push(b);
        a ? (f && (h.pointerWidth = 0), "right" == e ? f ? h.setBounds(n, s + m, n + p + l, s + q + m) : h.setBounds(n + p + l + g, s + m, n + p + 1E3, s + q + m) : f ? h.setBounds(n, s, p + n, q + s) : h.setBounds( - 1E3, -1E3, n - r - g, s + q + 15)) : (h.maxWidth = p, d.parseDates && (r = 0, h.pointerWidth = 0), "top" == e ? f ? h.setBounds(n + l, s + m, p + l + n, q + s) : h.setBounds(n + l, -1E3, p + l + n, s + m - r - g) : f ? h.setBounds(n, s, p + n, q + s - r) : h.setBounds(n, s + q + r + g - 1, n + p, s + q + r + g));
        this.hideCursor()
    },
    ...
    updateCursor: function(a, b) {
        ...
        if (this.enabled) {
            ...
            I = d.graphs,
            G = g.axisThickness;
            if (d.mouseIsOver || A || C || this.forceShow) if (this.forceShow = !1, C) {
                h = this.panClickPos;
                ...
                h.chart = this.chart, g.parseDates && !g.equalSpacing ? (d + e > x && (e = x - d), A + e < v && (e = v - A), h.start = A + e, h.end = d + e, this.fire(h.type, h)) : k + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = k + e, this.fire(h.type, h)))
            } else {
                ...
                A && (q ? this.updateSelectionSize(NaN, p) : this.updateSelectionSize(p, NaN));
                v = !0;
                A && (v = !1);
                ...
                if (I && this.valueBalloonsEnabled && v && d.balloon.enabled) {
                    ...
                    if (this.oneBalloonOnly) {
                        ...
                        u.showBalloon && (!u.hidden && u.balloonText) && (t = s.axes[u.valueAxis.id].graphs[u.id], x = t.y, isNaN(x) || (q ? Math.abs(e - x) < j && (j = Math.abs(e - x), T = u) : Math.abs(f - x) < j && (j = Math.abs(f - x), T = u)))
                    }
                    for (g = 0; g < I.length; g++) if (u = I[g], !(this.oneBalloonOnly && u != T) && (u.showBalloon && !u.hidden && u.balloonText) && (t = s.axes[u.valueAxis.id].graphs[u.id], x = t.y, !isNaN(x))) {
                        p = t.x;
                        r = !0;
                        if (q) {
                            if (j = x, 0 > p || p > n) r = !1
        ...
        if (a) {
            ...
            if (this.enabled && 0 < this.data.length) {
                if (this.pan) this.rolledOver = !1;
                    ...
                    b.chart = this.chart;
                    if ("cursor" == this.type) this.rotate ? this.selectionPosY = a = e: this.selectionPosX = a = d,
                    2 > Math.abs(a - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (b.end = this.fromIndex, b.start = this.index) : (b.end = this.index, b.start = this.fromIndex), a = this.chart.categoryAxis, a.parseDates && !a.equalSpacing && (b.start = this.data[b.start].time, b.end = this.data[b.end].time), this.skipZoomDispatch || this.fire(b.type, b));
                    else {
    ...
    dispatchScrollbarEvent: function() {
        if (this.skipEvent) this.skipEvent = !1;
            ...
            if (e.parseDates && !e.equalSpacing) {
                ...
                h > a && (h = a);
                if (h != this.startTime || a != this.endTime) this.startTime = h,
                this.endTime = a,
                f.start = h,
                f.end = a,
                f.startDate = new Date(h),
                f.endDate = new Date(a),
                this.fire(f.type, f)
            } else if (e.startOnAxis || (b += g / 2), d -= this.stepWidth / 2, g = e.xToIndex(b), b = e.xToIndex(b + d), g != this.start || this.end != b) e.startOnAxis && (this.resizingRight && g == b && b++, this.resizingLeft && g == b && (0 < g ? g--:b = 1)),
            this.start = g,
            this.end = this.dragging ? this.start + this.difference: b,
            f.start = this.start,
            f.end = this.end,
            e.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))),
            this.fire(f.type, f)
        }
    },
    zoomScrollbar: function() {
        ...
        var d = this.categoryAxis,
        e;
        d.parseDates && !d.equalSpacing ? (e = d.stepWidth, b = b[0].time, a = e * (this.startTime - b), b = e * (this.endTime - b), d = d.minDuration(), b = 6048E5 > Number(d) ? b + d * e: b + 864E5 * e) : (a = b[this.start].x[d.id], b = b[this.end].x[d.id], e = d.stepWidth, d.startOnAxis || (d = e / 2, a -= d, b += d));
        this.stepWidth = e;
...
AmCharts.wedge = function(a, b, d, e, f, g, h, j, k, l, m) {
    ...
    f = "";
    if (0 < k) {
        p ? (path = " M" + q + "," + (u + k) + " L" + t + "," + (v + k), I || (path += " A" + (b - g) + "," + (k + d - h) + "," + (b + g) + "," + (k + d + h) + "," + t + "," + (v + k) + "," + x + "," + (y + k)), path += " L" + w + "," + (r + k), 0 < j && (I || (path += " B" + (b - j) + "," + (k + d - s) + "," + (b + j) + "," + (k + d + s) + "," + w + "," + (k + r) + "," + q + "," + (k + u)))) : (path = " M" + q + "," + (u + k) + " L" + t + "," + (v + k), path += " A" + g + "," + h + ",0," + C + ",1," + x + "," + (y + k) + " L" + w + "," + (r + k), 0 < j && (path += " A" + j + "," + s + ",0," + C + ",0," + q + "," + (u + k)));
        path += " Z";
    ...
    p ? (I || (f = " A" + n(b - g) + "," + n(d - h) + "," + n(b + g) + "," + n(d + h) + "," + n(t) + "," + n(v) + "," + n(x) + "," + n(y)), g = " M" + n(q) + "," + n(u) + " L" + n(t) + "," + n(v) + f + " L" + n(w) + "," + n(r)) : g = " M" + q + "," + u + " L" + t + "," + v + (" A" + g + "," + h + ",0," + C + ",1," + x + "," + y) + " L" + w + "," + r;
    ...
    parseData: function() {
        ...
        if (void 0 !== b) {
            ...
            for (f = 0; f < d; f++) {
                ...
                j || (j = "");
                g.title = j;
                g.pulled = AmCharts.toBoolean(h[this.pulledField], !1); (j = h[this.descriptionField]) || (j = "");
                g.description = j;
